...
<div>
    <span class="text-muted h6">
        <span class="glyphicon glyphicon-info-sign"></span> &nbsp; <?php echo Yii::t('EavModule.eavactiverecord', 'This can be useful for checking if the multivalued attribute has the allowed number of values') ?>
    </span>
</div>
<br>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        ...
        <?php echo CHtml::activeHiddenField($model, 'enableClientValidation') ?>
    </div>
</div>
...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'tooMany', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'tooMany', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'tooMany', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>

<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'tooLittle', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'tooLittle', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'tooLittle', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>
