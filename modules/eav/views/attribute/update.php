...
<ol class="breadcrumb">
    ...
    <li class="active"><?php echo Yii::t('EavModule.eavactiverecord', 'Edit attribute') ?></li>
</ol>

<div class="page-header">
    <h4>
        <?php echo Yii::t('EavModule.eavactiverecord', 'Edit attribute') ?>
    </h4>
</div>

<?php $form = $this->beginWidget('CActiveForm', array('id' => 'attribute-update-form', 'method' => 'post', 'htmlOptions' => array('class' => 'form-horizontal'))) ?>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <?php echo $form->dropDownList($model, 'data_type', $model->getDataTypeLabels(), array('class' => 'form-control', 'empty' => Yii::t('EavModule.eavactiverecord', 'Please select'), 'disabled' => 'disabled')) ?>
        <span class="help-block">
...
<?php Yii::app()->getComponent('clientScript')->registerScript('js-attribute-update-form', new CJavaScriptExpression($js), CClientScript::POS_END) ?>
