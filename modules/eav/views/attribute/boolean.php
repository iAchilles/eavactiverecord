...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'falseValue', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'falseValue', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'falseValue', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>

<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'trueValue', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'trueValue', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'trueValue', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>