...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'setOnEmpty', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
            <?php echo CHtml::activeRadioButtonList($model, 'setOnEmpty',
                array('true' => Yii::t('EavModule.eavactiverecord', 'Yes'), 'false' => Yii::t('EavModule.eavactiverecord', 'No')),
                array('container' => 'div',
                      'separator' => '',
                      'template' => '{beginLabel}{input}{labelTitle}{endLabel}',
            ...
            ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'setOnEmpty', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>

<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'value', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'value', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'value', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>
