...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'range', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'range', array('class' => 'form-control', 'placeholder' => Yii::t('EavModule.eavactiverecord', 'A comma separated list of values'))) ?>
        <span class="help-block">
