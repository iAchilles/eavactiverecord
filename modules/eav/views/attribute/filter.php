...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'filter', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'filter', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'filter', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>
