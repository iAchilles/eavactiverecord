...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'format', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'format', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'format', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>

<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'timestampAttribute', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'timestampAttribute', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'timestampAttribute', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>