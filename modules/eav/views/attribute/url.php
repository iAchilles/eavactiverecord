...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'validSchemes', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'validSchemes', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'validSchemes', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>

<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'defaultScheme', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'defaultScheme', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'defaultScheme', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>
