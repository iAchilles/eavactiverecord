...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'requiredValue', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'requiredValue', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'requiredValue', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>
...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'trim', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
            <?php echo CHtml::activeRadioButtonList($model, 'trim',
            array('true' => Yii::t('EavModule.eavactiverecord', 'Enabled'), 'false' => Yii::t('EavModule.eavactiverecord', 'Disabled')),
                array('container' => 'div',
                      'separator' => '',
                      'template' => '{beginLabel}{input}{labelTitle}{endLabel}',
            ...
            ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'trim', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>
