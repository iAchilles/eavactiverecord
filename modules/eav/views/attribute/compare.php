...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'strict', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
            <?php echo CHtml::activeRadioButtonList($model, 'strict',
                array('true' => Yii::t('EavModule.eavactiverecord', 'Enabled'), 'false' => Yii::t('EavModule.eavactiverecord', 'Disabled')),
                array('container' => 'div',
                      'separator' => '',
                      'template' => '{beginLabel}{input}{labelTitle}{endLabel}',
            ...
            ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'strict', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>
...
<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'compareAttribute', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'compareAttribute', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'compareAttribute', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>

<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'compareValue', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'compareValue', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'compareValue', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>

<div class="form-group">
    <?php echo CHtml::activeLabel($model, 'operator', array('class' => 'col-md-3 control-label')) ?>
    <div class="col-md-5">
        <?php echo CHtml::activeTextField($model, 'operator', array('class' => 'form-control')) ?>
        <span class="help-block">
            <?php echo CHtml::error($model, 'operator', array('class' => 'label label-danger')) ?>
        </span>
    </div>
</div>